...
class TestResolvers(IntegrationTest):
    ...
    def test_display_resolvers_config_without_ipa_installed(self, host):
    ...
    def test_display_resolvers_config_with_manual_resolv_conf(self, host):
    ...
    def test_display_resolvers_config_after_time_interval(self, host):
        self.display_resolver_config(self.client)
    ...
    def test_display_resolvers_config_with_restored_resolv_conf(self, host):
        self.display_resolver_config(self.client)

    def test_dnf_works_with_restored_resolv_conf(self, host):
        self.check_dnf_works(self.client)
